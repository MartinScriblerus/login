...
function _PrintFloatArray(array, size) {
 for (var i = 0; i < size; i++) console.log(HEAPF32[(array >> 2) + size]);
}
...
function _setListenerTransform(x, y, z, forwardX, forwardY, forwardZ, upX, upY, upZ) {
...
var asmLibraryArg = {
 ...
 "mktime": _mktime,
 "setListenerTransform": _setListenerTransform,
...
var dynCall_ifffffffffi = Module["dynCall_ifffffffffi"] = createExportWrapper("dynCall_ifffffffffi");
